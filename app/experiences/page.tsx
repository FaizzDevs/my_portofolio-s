...
const projects = [
    ...
    {
        num: '07',
        category: 'Power BI - Health Analysis',
        title: 'project 6',
        desc: 'This project focused on analyzing healthcare data from several hospitals to understand service performance, disease trends, and patient profiles. The data was collected from internal hospital reports and processed using Power BI to create an interactive dashboard that can be used by management for strategic decision-making.',
